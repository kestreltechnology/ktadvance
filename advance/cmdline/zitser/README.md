## Scripts to run the Samate Medium Test Cases

The scripts in this directory are dedicated to running the analysis on
the Zitser test cases in the directory tests/sard/zitser.

The Zitser test cases are test cases number 1283 through 1310 from the
